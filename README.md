...
- 📊 **Barra de datos al pie**: una línea discreta al final del lector con el
  tiempo que llevas dedicado al libro (que abre su ficha al pulsarlo), la
  ...
  el móvil. En el modo de **páginas continuas** el texto no se reparte en
  columnas y no hay pantallas que contar, así que en su lugar va el porcentaje
  leído, igual que en los PDF. La pantalla del capítulo se calla cuando el
  capítulo cabe entero en una: «1 / 1» no dice nada, y en pantalla ancha pasa a
  menudo. Se puede apagar en los ajustes.
...
- 🗂️ **Ajustes por pestañas**: la pantalla de ajustes se reparte en «Nube»,
  «Biblioteca», «Lector» y «Datos», y recuerda en cuál estabas.
