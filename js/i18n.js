...
const textos = {
  ...
  ca: {
    ...
    searchBook: 'Cerca dins del llibre', showBookIndex: 'Mostra l’índex', bookIndex: 'Índex del llibre', bookStart: 'Inici del llibre', historyNavigation: 'Historial de navegació', backPosition: 'Torna a la posició anterior', forwardPosition: 'Avança a la posició següent', wordOrPhrase: 'Paraula o frase', search: 'Cerca', close: 'Tanca',
  ...
  en: {
    ...
    searchBook: 'Search inside the book', showBookIndex: 'Show table of contents', bookIndex: 'Table of contents', bookStart: 'Start of book', historyNavigation: 'Navigation history', backPosition: 'Back to previous position', forwardPosition: 'Forward to next position', wordOrPhrase: 'Word or phrase', search: 'Search', close: 'Close',
