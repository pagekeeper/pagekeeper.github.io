...
const textos = {
  es: {
    ...
    searchBook: 'Buscar dentro del libro', showBookIndex: 'Mostrar el índice', bookIndex: 'Índice del libro', bookStart: 'Inicio del libro', wordOrPhrase: 'Palabra o frase', search: 'Buscar', close: 'Cerrar',
  ...
  ca: {
    ...
    searchBook: 'Cerca dins del llibre', showBookIndex: 'Mostra l’índex', bookIndex: 'Índex del llibre', bookStart: 'Inici del llibre', wordOrPhrase: 'Paraula o frase', search: 'Cerca', close: 'Tanca',
  ...
  en: {
    ...
    searchBook: 'Search inside the book', showBookIndex: 'Show table of contents', bookIndex: 'Table of contents', bookStart: 'Start of book', wordOrPhrase: 'Word or phrase', search: 'Search', close: 'Close',
