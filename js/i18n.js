...
const textos = {
  es: {
    ...
    notePrompt: 'Nota sobre el texto seleccionado:', editNotePrompt: 'Edita esta nota:', editNote: 'Editar nota', deleteAnnotation: 'Borrar anotación', deleteAnnotationConfirm: '¿Borrar esta anotación?', noteActions: 'Opciones de la nota', openNote: 'Abrir nota',
  ...
  ca: {
    ...
    notePrompt: 'Nota sobre el text seleccionat:', editNotePrompt: 'Edita aquesta nota:', editNote: 'Edita la nota', deleteAnnotation: 'Esborra l’anotació', deleteAnnotationConfirm: 'Vols esborrar aquesta anotació?', noteActions: 'Opcions de la nota', openNote: 'Obre la nota',
  ...
  en: {
    ...
    notePrompt: 'Note about the selected text:', editNotePrompt: 'Edit this note:', editNote: 'Edit note', deleteAnnotation: 'Delete annotation', deleteAnnotationConfirm: 'Delete this annotation?', noteActions: 'Note options', openNote: 'Open note',
