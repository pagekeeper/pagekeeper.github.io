...
const textos = {
  es: {
    ...
    margins: 'Ajustar márgenes', zoom: 'Zoom', zoomOut: 'Reducir', autoWidth: 'Ancho automático', zoomIn: 'Ampliar',
    ...
    makeAvailableOffline: 'Hacer «{title}» disponible sin conexión', removeOfflineCopy: 'Quitar la copia sin conexión de «{title}»',
    updateOfflineCopy: 'Actualizar la copia sin conexión de «{title}»',
    ...
    timeLessMinute: 'menos de 1 min', timeMinutes: '{m} min', timeHoursMinutes: '{h} h {m} min',
    ...
    searchBook: 'Buscar dentro del libro', showBookIndex: 'Mostrar el índice', bookIndex: 'Índice del libro', bookStart: 'Inicio del libro', historyNavigation: 'Historial de navegación', backPosition: 'Volver a la posición anterior', forwardPosition: 'Avanzar a la posición siguiente', pageAndHistory: 'Página e historial de navegación', wordOrPhrase: 'Palabra o frase', search: 'Buscar', close: 'Cerrar',
    ...
    note: 'Nota', notePrompt: 'Nota sobre el texto seleccionado:', editNotePrompt: 'Edita esta nota:', editNote: 'Editar nota', deleteAnnotation: 'Borrar anotación', deleteAnnotationConfirm: '¿Borrar esta anotación?', noteActions: 'Opciones de la nota', openNote: 'Abrir nota',
  ...
  ca: {
    ...
    margins: 'Ajusta els marges', zoom: 'Zoom', zoomOut: 'Redueix', autoWidth: 'Amplada automàtica', zoomIn: 'Amplia',
    ...
    makeAvailableOffline: 'Fes que «{title}» estigui disponible sense connexió', removeOfflineCopy: 'Treu la còpia sense connexió de «{title}»',
    updateOfflineCopy: 'Actualitza la còpia sense connexió de «{title}»',
    ...
    timeLessMinute: 'menys d’1 min', timeMinutes: '{m} min', timeHoursMinutes: '{h} h {m} min',
    ...
    searchBook: 'Cerca dins del llibre', showBookIndex: 'Mostra l’índex', bookIndex: 'Índex del llibre', bookStart: 'Inici del llibre', historyNavigation: 'Historial de navegació', backPosition: 'Torna a la posició anterior', forwardPosition: 'Avança a la posició següent', pageAndHistory: 'Pàgina i historial de navegació', wordOrPhrase: 'Paraula o frase', search: 'Cerca', close: 'Tanca',
    ...
    note: 'Nota', notePrompt: 'Nota sobre el text seleccionat:', editNotePrompt: 'Edita aquesta nota:', editNote: 'Edita la nota', deleteAnnotation: 'Esborra l’anotació', deleteAnnotationConfirm: 'Vols esborrar aquesta anotació?', noteActions: 'Opcions de la nota', openNote: 'Obre la nota',
  ...
  en: {
    ...
    margins: 'Adjust margins', zoom: 'Zoom', zoomOut: 'Zoom out', autoWidth: 'Fit to width', zoomIn: 'Zoom in',
    ...
    makeAvailableOffline: 'Make “{title}” available offline', removeOfflineCopy: 'Remove the offline copy of “{title}”',
    updateOfflineCopy: 'Update the offline copy of “{title}”',
    ...
    timeLessMinute: 'under 1 min', timeMinutes: '{m} min', timeHoursMinutes: '{h} h {m} min',
    ...
    searchBook: 'Search inside the book', showBookIndex: 'Show table of contents', bookIndex: 'Table of contents', bookStart: 'Start of book', historyNavigation: 'Navigation history', backPosition: 'Back to previous position', forwardPosition: 'Forward to next position', pageAndHistory: 'Page and navigation history', wordOrPhrase: 'Word or phrase', search: 'Search', close: 'Close',
    ...
    note: 'Note', notePrompt: 'Note about the selected text:', editNotePrompt: 'Edit this note:', editNote: 'Edit note', deleteAnnotation: 'Delete annotation', deleteAnnotationConfirm: 'Delete this annotation?', noteActions: 'Note options', openNote: 'Open note',
