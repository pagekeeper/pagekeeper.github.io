...
const textos = {
  es: {
    ...
    bookLinkConfirm: 'Se descargará «{title}» de {host}.', bookLinkInvalid: 'El enlace del libro no es válido.',
    bookLinkFailed: 'No se ha podido descargar el libro.', bookLinkTooBig: 'El libro pesa demasiado para descargarlo.',
    bookLinkTitle: 'Añadir libro a la biblioteca', bookLinkAdd: 'Añadir y leer', bookLinkSaveCloud: 'Guardarlo en mi nube', bookLinkSaveLocal: 'Guardarlo solo en este dispositivo',
  ...
  ca: {
    ...
    bookLinkConfirm: 'Es baixarà «{title}» de {host}.', bookLinkInvalid: 'L’enllaç del llibre no és vàlid.',
    bookLinkFailed: 'No s’ha pogut baixar el llibre.', bookLinkTooBig: 'El llibre pesa massa per baixar-lo.',
    bookLinkTitle: 'Afegeix el llibre a la biblioteca', bookLinkAdd: 'Afegeix i llegeix', bookLinkSaveCloud: 'Desa’l al meu núvol', bookLinkSaveLocal: 'Desa’l només en aquest dispositiu',
  ...
  en: {
    ...
    bookLinkConfirm: '“{title}” will be downloaded from {host}.', bookLinkInvalid: 'The book link is not valid.',
    bookLinkFailed: 'The book could not be downloaded.', bookLinkTooBig: 'The book is too large to download.',
    bookLinkTitle: 'Add book to your library', bookLinkAdd: 'Add and read', bookLinkSaveCloud: 'Save it to my cloud', bookLinkSaveLocal: 'Save it only on this device',
  ...
  fr: {
    ...
    bookLinkConfirm: '« {title} » sera téléchargé depuis {host}.', bookLinkInvalid: 'Le lien du livre n’est pas valide.',
    bookLinkFailed: 'Le livre n’a pas pu être téléchargé.', bookLinkTooBig: 'Le livre est trop volumineux pour être téléchargé.',
    bookLinkTitle: 'Ajouter le livre à la bibliothèque', bookLinkAdd: 'Ajouter et lire', bookLinkSaveCloud: 'L’enregistrer dans mon nuage', bookLinkSaveLocal: 'L’enregistrer seulement sur cet appareil',
  ...
  gl: {
    ...
    bookLinkConfirm: 'Descargarase «{title}» de {host}.', bookLinkInvalid: 'A ligazón do libro non é válida.',
    bookLinkFailed: 'Non se puido descargar o libro.', bookLinkTooBig: 'O libro pesa de máis para descargalo.',
    bookLinkTitle: 'Engadir o libro á biblioteca', bookLinkAdd: 'Engadir e ler', bookLinkSaveCloud: 'Gardalo na miña nube', bookLinkSaveLocal: 'Gardalo só neste dispositivo',
  ...
  eu: {
    ...
    bookLinkConfirm: '«{title}» {host} gunetik deskargatuko da.', bookLinkInvalid: 'Liburuaren esteka ez da baliozkoa.',
    bookLinkFailed: 'Ezin izan da liburua deskargatu.', bookLinkTooBig: 'Liburua handiegia da deskargatzeko.',
    bookLinkTitle: 'Gehitu liburua liburutegira', bookLinkAdd: 'Gehitu eta irakurri', bookLinkSaveCloud: 'Gorde nire hodeian', bookLinkSaveLocal: 'Gorde gailu honetan bakarrik',
  ...
  de: {
    ...
    bookLinkConfirm: '„{title}“ wird von {host} heruntergeladen.', bookLinkInvalid: 'Der Buchlink ist ungültig.',
    bookLinkFailed: 'Das Buch konnte nicht heruntergeladen werden.', bookLinkTooBig: 'Das Buch ist zu groß zum Herunterladen.',
    bookLinkTitle: 'Buch zur Bibliothek hinzufügen', bookLinkAdd: 'Hinzufügen und lesen', bookLinkSaveCloud: 'In meiner Cloud speichern', bookLinkSaveLocal: 'Nur auf diesem Gerät speichern',
  ...
  pt: {
    ...
    bookLinkConfirm: '«{title}» será descarregado de {host}.', bookLinkInvalid: 'A hiperligação do livro não é válida.',
    bookLinkFailed: 'Não foi possível descarregar o livro.', bookLinkTooBig: 'O livro é demasiado grande para descarregar.',
    bookLinkTitle: 'Adicionar o livro à biblioteca', bookLinkAdd: 'Adicionar e ler', bookLinkSaveCloud: 'Guardá-lo na minha nuvem', bookLinkSaveLocal: 'Guardá-lo só neste dispositivo',
