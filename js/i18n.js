...
const textos = {
  es: {
    ...
    cleanupHelp: 'Si borras un libro fuera de PageKeeper, su marca de lectura, sus marcadores y sus notas se quedan aquí. Se echan en falta primero y se borran después, por si el libro solo estaba fuera de alcance un rato.',
  ...
  ca: {
    ...
    cleanupHelp: 'Si esborres un llibre fora de PageKeeper, la marca de lectura, els marcadors i les notes es queden aquí. Primer es troben a faltar i després s’esborren, per si el llibre només era fora d’abast una estona.',
  ...
  en: {
    ...
    cleanupHelp: 'If you delete a book outside PageKeeper, its reading position, bookmarks and notes stay here. They are first noted as missing and only deleted later, in case the book was merely out of reach for a while.',
