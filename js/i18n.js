...
const textos = {
  es: {
    ...
    notePrompt: 'Nota sobre el texto seleccionado:', editNote: 'Editar nota', deleteAnnotation: 'Borrar anotación',
  ...
  ca: {
    ...
    notePrompt: 'Nota sobre el text seleccionat:', editNote: 'Edita la nota', deleteAnnotation: 'Esborra l’anotació',
  ...
  en: {
    ...
    notePrompt: 'Note about the selected text:', editNote: 'Edit note', deleteAnnotation: 'Delete annotation',
