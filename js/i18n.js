...
const textos = {
  es: {
    ...
    continueReading: 'Continuar leyendo', recentCount: 'Cuántas lecturas mostrar', recentAuto: 'Las que quepan', recentN: '{count} lecturas', removeContinue: 'Quitar «Continuar leyendo» de la biblioteca', continueRemoved: 'Se ha quitado «Continuar leyendo». Puedes volver a mostrarlo en Ajustes → Biblioteca.', continueReadingHelp: 'Tu lectura más reciente, con las demás a un toque',
  ...
  ca: {
    ...
    continueReading: 'Continua llegint', recentCount: 'Quantes lectures mostrar', recentAuto: 'Les que hi càpiguen', recentN: '{count} lectures', removeContinue: 'Treu «Continua llegint» de la biblioteca', continueRemoved: 'S’ha tret «Continua llegint». El pots tornar a mostrar a Configuració → Biblioteca.', continueReadingHelp: 'La lectura més recent, amb les altres a un toc',
  ...
  en: {
    ...
    continueReading: 'Continue reading', recentCount: 'How many reads to show', recentAuto: 'As many as fit', recentN: '{count} reads', removeContinue: 'Remove “Continue reading” from the library', continueRemoved: '“Continue reading” has been removed. You can show it again in Settings → Library.', continueReadingHelp: 'Your latest read, with the others one tap away',
