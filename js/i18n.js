...
const textos = {
  es: {
    ...
    emptyLocalAction: 'Pulsa aquí para añadir tus libros en este dispositivo',
    emptyLocalHelp: 'Selecciona archivos PDF o EPUB, o arrástralos hasta esta zona',
  ...
  ca: {
    ...
    emptyLocalAction: 'Prem aquí per afegir els teus llibres en aquest dispositiu',
    emptyLocalHelp: 'Selecciona fitxers PDF o EPUB, o arrossega’ls fins a aquesta zona',
  ...
  en: {
    ...
    emptyLocalAction: 'Click here to add your books to this device',
    emptyLocalHelp: 'Select PDF or EPUB files, or drag them onto this area',
