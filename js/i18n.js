...
const textos = {
  es: {
    ...
    bookLinkConfirm: '¿Descargar «{title}» de {host} y añadirlo a la biblioteca?', bookLinkInvalid: 'El enlace del libro no es válido.',
    bookLinkFailed: 'No se ha podido descargar el libro.', bookLinkTooBig: 'El libro pesa demasiado para descargarlo.', bookLinkToCloud: '¿Guardar «{title}» también en tu nube?',
  ...
  ca: {
    ...
    bookLinkConfirm: 'Vols baixar «{title}» de {host} i afegir-lo a la biblioteca?', bookLinkInvalid: 'L’enllaç del llibre no és vàlid.',
    bookLinkFailed: 'No s’ha pogut baixar el llibre.', bookLinkTooBig: 'El llibre pesa massa per baixar-lo.', bookLinkToCloud: 'Vols desar «{title}» també al teu núvol?',
  ...
  en: {
    ...
    bookLinkConfirm: 'Download “{title}” from {host} and add it to your library?', bookLinkInvalid: 'The book link is not valid.',
    bookLinkFailed: 'The book could not be downloaded.', bookLinkTooBig: 'The book is too large to download.', bookLinkToCloud: 'Also save “{title}” to your cloud?',
  ...
  fr: {
    ...
    bookLinkConfirm: 'Télécharger « {title} » depuis {host} et l’ajouter à la bibliothèque ?', bookLinkInvalid: 'Le lien du livre n’est pas valide.',
    bookLinkFailed: 'Le livre n’a pas pu être téléchargé.', bookLinkTooBig: 'Le livre est trop volumineux pour être téléchargé.', bookLinkToCloud: 'Enregistrer aussi « {title} » dans votre nuage ?',
  ...
  gl: {
    ...
    bookLinkConfirm: 'Queres descargar «{title}» de {host} e engadilo á biblioteca?', bookLinkInvalid: 'A ligazón do libro non é válida.',
    bookLinkFailed: 'Non se puido descargar o libro.', bookLinkTooBig: 'O libro pesa de máis para descargalo.', bookLinkToCloud: 'Queres gardar «{title}» tamén na túa nube?',
  ...
  eu: {
    ...
    bookLinkConfirm: '«{title}» {host} gunetik deskargatu eta liburutegira gehitu nahi duzu?', bookLinkInvalid: 'Liburuaren esteka ez da baliozkoa.',
    bookLinkFailed: 'Ezin izan da liburua deskargatu.', bookLinkTooBig: 'Liburua handiegia da deskargatzeko.', bookLinkToCloud: '«{title}» zure hodeian ere gorde nahi duzu?',
  ...
  de: {
    ...
    bookLinkConfirm: '„{title}“ von {host} herunterladen und zur Bibliothek hinzufügen?', bookLinkInvalid: 'Der Buchlink ist ungültig.',
    bookLinkFailed: 'Das Buch konnte nicht heruntergeladen werden.', bookLinkTooBig: 'Das Buch ist zu groß zum Herunterladen.', bookLinkToCloud: '„{title}“ auch in deiner Cloud speichern?',
  ...
  pt: {
    ...
    bookLinkConfirm: 'Descarregar «{title}» de {host} e adicioná-lo à biblioteca?', bookLinkInvalid: 'A hiperligação do livro não é válida.',
    bookLinkFailed: 'Não foi possível descarregar o livro.', bookLinkTooBig: 'O livro é demasiado grande para descarregar.', bookLinkToCloud: 'Guardar «{title}» também na sua nuvem?',
