...
const textos = {
  es: {
    ...
    markFinished: 'Marcar «{title}» como terminado', markUnfinished: 'Volver a marcar «{title}» como pendiente', finished: 'Terminado',
    sampleBookHeading: 'Empieza con un libro de ejemplo', sampleBookHelp: 'Tu biblioteca está vacía. Puedes probar PageKeeper con',
    sampleBookTitle: 'Lazarillo de Tormes', loadSampleBook: 'Añadir y abrir', loadingSampleBook: 'Preparando el libro de ejemplo…',
  ...
  ca: {
    ...
    markFinished: 'Marca «{title}» com a acabat', markUnfinished: 'Torna a marcar «{title}» com a pendent', finished: 'Acabat',
    sampleBookHeading: 'Comença amb un llibre d’exemple', sampleBookHelp: 'La biblioteca és buida. Pots provar PageKeeper amb',
    sampleBookTitle: 'L’auca del senyor Esteve', loadSampleBook: 'Afegeix i obre', loadingSampleBook: 'S’està preparant el llibre d’exemple…',
  ...
  en: {
    ...
    markFinished: 'Mark “{title}” as finished', markUnfinished: 'Mark “{title}” as pending again', finished: 'Finished',
    sampleBookHeading: 'Start with a sample book', sampleBookHelp: 'Your library is empty. You can try PageKeeper with',
    sampleBookTitle: 'Alice’s Adventures in Wonderland', loadSampleBook: 'Add and open', loadingSampleBook: 'Preparing the sample book…',
