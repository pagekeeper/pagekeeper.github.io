...
const textos = {
  es: {
    ...
    localBackup: 'Copia de la biblioteca local',
    localBackupHelp: 'Guarda en un ZIP los libros de «En este dispositivo», su progreso, marcadores, anotaciones y preferencias. No incluye la configuración ni la contraseña de la nube.',
    exportLocalBackup: 'Crear copia', restoreLocalBackup: 'Restaurar copia',
  ...
  ca: {
    ...
    localBackup: 'Còpia de la biblioteca local',
    localBackupHelp: 'Desa en un ZIP els llibres de «En aquest dispositiu», el progrés, els marcadors, les anotacions i les preferències. No inclou la configuració ni la contrasenya del núvol.',
    exportLocalBackup: 'Crea una còpia', restoreLocalBackup: 'Restaura una còpia',
  ...
  en: {
    ...
    localBackupHelp: 'Saves the books under “On this device”, their progress, bookmarks, annotations and preferences in a ZIP. Cloud configuration and password are not included.',
    exportLocalBackup: 'Create backup', restoreLocalBackup: 'Restore backup',
