...
const textos = {
  es: {
    ...
    activityLogHelp: 'Deja constancia de si la posición de lectura llega al servidor y de los errores que impiden que llegue. Sirve para averiguar por qué un libro se quedó atrás en otro dispositivo. Se guarda solo aquí y nunca sale de este aparato.',
  ...
  ca: {
    ...
    activityLogHelp: 'Deixa constància de si la posició de lectura arriba al servidor i dels errors que ho impedeixen. Serveix per esbrinar per què un llibre s’ha quedat enrere en un altre dispositiu. Es desa només aquí i no surt mai d’aquest aparell.',
  ...
  en: {
    ...
    activityLogHelp: 'Records whether your reading position reaches the server, and the errors that stop it. Useful for finding out why a book lagged behind on another device. Stored here only; it never leaves this device.',
